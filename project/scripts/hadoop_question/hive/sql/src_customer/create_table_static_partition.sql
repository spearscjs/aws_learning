...
location "s3://quintrix-spearscjs/data/src_customer/customer_details_source_partitions/"
...
-- Static Partitions to be added manually. Its alter table command. [ dataset_date=2022-01-02 ]

alter table customer_details_source_partitions add partition (dataset_date='2022-01-02');

aws s3 cp s3://quintrix-spearscjs/cards_ingest/account_src/cards_account_ingest_2022-01-02.csv s3://quintrix-spearscjs/data/src_customer/customer_details_source_partitions/dataset_date='2022-01-02'/

select count(1),dataset_date from customer_details_source_partitions group by dataset_date ;
+-------+-------------+
|  _c0  |  dataset_date  |
+-------+-------------+
| 4999  | 2022-01-02  |
...
-- Static Partitions to be added manually. Its alter table command. [ dataset_date=2022-01-03 ]
alter table customer_details_source_partitions add partition (dataset_date='2022-01-03');
...
| 4999  | 2022-01-02  |
+-------+-------------+
aws s3 cp s3://quintrix-spearscjs/cards_ingest/account_src/cards_account_ingest_2022-01-03.csv s3://quintrix-spearscjs/data/src_customer/customer_details_source_partitions/dataset_date='2022-01-03'/
